...
//                .csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET,"/","/login", "/client/**", "/css/**", "/js/**","/product/**",
                                "/images/**","/register","/api/**", "/products/**", "/forgot-password/**").permitAll()
                        .requestMatchers(HttpMethod.POST,"/register", "/forgot-password/**", "/api/auth/login", "/api/add-product-to-cart", "/forgot-password/**").permitAll()
