        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <p class="para-text">Chào mừng đến với LaptopVN - thế giới laptop. Chúng tôi tự tin mang đến cho khách hàng những sản phẩm công nghệ tốt nhất. Hãy đến và khám phá ngay nhé</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://hoidanit.vn" target="_blank"><i
                                class="fas fa-copyright text-light me-2"></i>LaptopVN</a>, All right
                            reserved.</span>
            </div>
